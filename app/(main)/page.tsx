  ...
  return (
    <div>
      ...
      <div className='ml-16 relative'>
        <header className='bg-slate-50 lg:fixed lg:inset-0 lg:w-112 lg:left-16 xl:w-120 bg-gradient-to-b from-cyan-50 via-white to-sky-50 shadow relative h-full overflow-y-auto lg:items-start flex flex-col'>
          <div className='z-10 relative'>
            <div className='mt-10 px-8 py-4'>
              ...
              <div className='px-3 mt-6 relative'>
                <Input placeholder='Search' className='py-6 px-6 pr-20' />
                <Button size='sm' className='absolute top-[10px] right-[20px]'>Search</Button>
              </div>

              <div className='mt-6 relative'>
                <Image src='/images/bg_svg/cloudy.svg' width={540} height={160} alt='Weather Image' className='shadow-lg rounded-[20px]' />
