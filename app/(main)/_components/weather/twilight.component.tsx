  ...
  return (
    <div className='mt-4 grid grid-cols-2 justify-between p-8'>
      <div className='flex items-center gap-6'>
        <Image src='/images/icon_svg/sunrise.svg' width={55} height={55} alt='Sunrise Image' className='drop-shadow' />
        <div className='grid gap-1'>
          <p className='text-xs md:text-sm'>Sunrise</p>
          <h3 className='text-sm md:text-xl font-semibold leading-none tracking-tighter select-none uppercase'>{formatTime(sunrise)}</h3>
        </div>
      </div>

      <div className='flex items-center gap-6'>
        <Image src='/images/icon_svg/sunset.svg' width={55} height={55} alt='Sunset Image' className='drop-shadow' />

        <div className='grid gap-1'>
          <p className='text-xs md:text-sm'>Sunset</p>
          <h3 className='text-sm md:text-xl font-semibold leading-none tracking-tighter select-none uppercase'>{formatTime(sunset)}</h3>
        </div>
      </div>
    </div>
  );
