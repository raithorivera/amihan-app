  ...
  return (
    <div className='flex items-center justify-between p-8 '>
      <div className='grid grid-cols-4 gap-1 w-full'>
        <Image src='/images/icon_svg/cloud-gust.svg' width={65} height={65} alt='Sunrise Image' className='drop-shadow col-span-1' />

        <div className='col-span-3 flex justify-between items-center w-full -ml-4'>
