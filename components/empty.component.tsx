...
export default function EmptyComponent({
  ...
  return (
    <div className='flex flex-col gap-2 items-center justify-center py-40 text-center leading-snug w-full'>
      <Image src={image} alt='Empty Image' width={width} height={height} className='mt-20 w-[160px] md:w-[360px]' />
      <h2 className='text-sm md:text-lg font-semibold mt-6'>{title}</h2>
      <p className='text-xs md:text-base md:w-[40ch]'>{description}</p>
